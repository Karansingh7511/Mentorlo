...
<div className="">
      ...
      <div className='cont d-flex-sb'>
        ...
        <div>
          ...
          <p className='ind_txt'>Quick snapshot to keep you informed & organized</p>
          < p className='ind_txt2'>The dashboard offers an overview of all the upcoming &
          <br />
          past mentorship calls. Check the schedule, recent notifications, and important updates in one centralized location</p>
        </div>
