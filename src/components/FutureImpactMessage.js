...
<div className='d-flex topdiv'>
      ...
      >
        <p className='inner_txt_1'>Push them to do better</p>
        <p className='inner_txt_2'>Encourage them to get out of their comfort zone and cultivate skills relevant to the digital world.</p>
      </div>
      <div
        className={`inner ${selectedDiv === 3 ? 'bb' : ''}`}
        onClick={() => handleClick(3)}
      >
        <p className='inner_txt_1'>Empower their network</p>
        <p className='inner_txt_2'>Help them build valuable connections to make an informed career decision in the future.</p>
      </div>
